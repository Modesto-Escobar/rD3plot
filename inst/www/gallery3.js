function gallery(Graph){
  pageZoom(Graph.options.scale,Graph.options.imageRatio);
...
+".grid-gallery-mode3 > .gallery-items > .item-card > .item-card-inner > .img-wrapper { height: "+((200/ratio)*zoom)+"px; }"
        )
    }
  }
