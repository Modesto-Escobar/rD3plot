function gallery(Graph){
  ...
  if(Graph.options.paginationPosition){
    if(Graph.options.paginationPosition==1){
      body.classed("pagination-top",true);
    }else if(Graph.options.paginationPosition==2){
      body.classed("pagination-bottom",true);
    }
  }
 ...
 if(Graph.options.multigraph){
  ...
  if(Graph.options.main){
    ...
    if(Graph.options.mainFixed){
      topbarContent.classed("fixed-main",true);
    }
  }
...
".grid-gallery-mode2 > .gallery-items > .item-card > .item-card-inner { padding: "+(24*zoom)+"px; width: unset; height: unset; }"
  ...
  function colorScheme(mode){
    ...
    var pallete = [
        ...
        ["#000000","#FFFFFF","#FFFFFF","#000000","#EFEFEF"]
      ];
